                    ...
                    <form id="userForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="invalid-feedback date_of_birth-error"></div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="invalid-feedback street_address-error"></div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="invalid-feedback apt_suite-error"></div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="invalid-feedback zip_code-error"></div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                                <label for="group" class="form-label">Password</label>
                                <div class="mb-3">
                                    <input type="text" class="form-control"  name="password" id="password" placeholder="Enter Zip Code">
                                </div>
...
<script>
    userForm.onsubmit = async (e)=>{
        e.preventDefault();
        makePostRequest("{{route('admin.users.clients.store')}}",userForm,'userForm');
    }
</script>
@endpush
