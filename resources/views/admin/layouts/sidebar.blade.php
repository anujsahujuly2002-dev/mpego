 ...
 <div class="sidenav-menu">
     ...
     <div data-simplebar>
         ...
         <ul class="side-nav">
             ...
             @endcanany
            @canany(['client-list', 'client-view', 'client-create','employee-edit','employee-list','employee-delete','employee-create'])
                <li class="side-nav-item @if (in_array(request()->route()->getName(), ['admin.users.clients','admin.users.clients.view.details','admin.users.clients.create','admin.users.employee.index','admin.users.employee.edit'])) active @endif">
                    <a data-bs-toggle="collapse" href="#users" aria-expanded="false" aria-controls="users" class="side-nav-link">
                        <span class="menu-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-user-cog">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" />
                            <path d="M6 21v-2a4 4 0 0 1 4 -4h2.5" />
                            <path d="M19.001 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" />
                    ...
                    <div class="collapse  @if (in_array(request()->route()->getName(), ['admin.users.clients','admin.users.clients.view.details','admin.users.clients.create','admin.users.employee.edit'])) show @endif" id="users">
                        <ul class="sub-menu">
                            @canany(['client-list', 'client-view', 'client-create'])
                                <li class="side-nav-item">
                                    <a href="{{ route('admin.users.clients.index') }}"
                                        class="side-nav-link @if (in_array(request()->route()->getName(), ['admin.users.clients.index', 'admin.users.clients.view.details', 'admin.users.clients.create'])) active @endif">
                                        <span class="menu-text">Clients</span>
                                    </a>
                                </li>
                            @endcanany
                            @canany(['employee-edit','employee-list','employee-delete','employee-create'])
                                <li class="side-nav-item">
                                    <a href="{{ route('admin.users.employee.index') }}"
                                        class="side-nav-link @if (in_array(request()->route()->getName(), ['admin.users.employee.index', 'admin.users.employee.create','admin.users.employee.edit'])) active @endif">
            ...
            @endcanany
            @canany(['vendor-delete','vendor-edit','vendor-create','vendor-list'])
                <li class="side-nav-item @if (in_array(request()->route()->getName(), ['admin.vendor.index','admin.vendor.create','admin.vendor.delete','admin.vendor.edit'])) active @endif">
                    <a href="{{ route('admin.vendor.index') }}" class="side-nav-link">
                        <span class="menu-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            @canany(['notification-list','notification-create','notification-edit','notification-delete'])
                <li class="side-nav-item @if (in_array(request()->route()->getName(), ['admin.notification.index','admin.notification.create'])) active @endif">
                    <a href="{{ route('admin.notification.index') }}" class="side-nav-link">
                        <span class="menu-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-help-square-rounded">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            @endcanany
             <li class="side-nav-item @if (in_array(request()->route()->getName(), ['admin.gift.card.index','admin.gift.card.create'])) active @endif">
                <a href="{{ route('admin.gift.card.index') }}" class="side-nav-link">
                    <span class="menu-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-help-square-rounded">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path d="M12 2l.642 .005l.616 .017l.299 .013l.579 .034l.553 .046c4.687 .455 6.65 2.333 7.166 6.906l.03 .29l.046 .553l.041 .727l.006 .15l.017 .617l.005 .642l-.005 .642l-.017 .616l-.013 .299l-.034 .579l-.046 .553c-.455 4.687 -2.333 6.65 -6.906 7.166l-.29 .03l-.553 .046l-.727 .041l-.15 .006l-.617 .017l-.642 .005l-.642 -.005l-.616 -.017l-.299 -.013l-.579 -.034l-.553 -.046c-4.687 -.455 -6.65 -2.333 -7.166 -6.906l-.03 -.29l-.046 -.553l-.041 -.727l-.006 -.15l-.017 -.617l-.004 -.318v-.648l.004 -.318l.017 -.616l.013 -.299l.034 -.579l.046 -.553c.455 -4.687 2.333 -6.65 6.906 -7.166l.29 -.03l.553 -.046l.727 -.041l.15 -.006l.617 -.017c.21 -.003 .424 -.005 .642 -.005zm0 13a1 1 0 0 0 -.993 .883l-.007 .117l.007 .127a1 1 0 0 0 1.986 0l.007 -.117l-.007 -.127a1 1 0 0 0 -.993 -.883zm1.368 -6.673a2.98 2.98 0 0 0 -3.631 .728a1 1 0 0 0 1.44 1.383l.171 -.18a.98 .98 0 0 1 1.11 -.15a1 1 0 0 1 -.34 1.886l-.232 .012a1 1 0 0 0 .111 1.994a3 3 0 0 0 1.371 -5.673z" /></svg>
                    </span>
